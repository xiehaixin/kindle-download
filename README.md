...
如果你想在其他地方管理代码，可以创建符号链接：

```bash
git clone https://github.com/xiehaixin/kindle-download.git /path/to/kindle-download
ln -s /path/to/kindle-download ~/.openclaw/workspace/skills/kindle-download
```
...
默认已配置多个 Z-Library 镜像站，可在 `zlibraryUrl.json` 中修改：
